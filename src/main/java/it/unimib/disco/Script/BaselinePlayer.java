...
public class BaselinePlayer {
	...
	public static void main(String[] args) throws ParseException, IOException {
		...
		int referenceLength = (2013-1983)+1;
		...
		for (Fact f : gs){
	        ...
	        System.out.println(f.get(Fact.Entry.SUBJECT)+"\t"+referenceLength + "\t" + solutionLength);
		...
		BufferedWriter bw = new BufferedWriter(new FileWriter(new File(directory.getAbsolutePath()+"/output/"+"evaluation_baseline_player.csv")));
